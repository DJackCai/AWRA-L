## 1. convert satellite soil moisture (e.g. Soil Moisture Active Passive (SMAP) retrievals) into relative wetness (0-1) 
## with respect to the dry extreme (wilting point) and wet extreme (field capacity) 
