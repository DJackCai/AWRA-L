...
### Updated 27th May: allow the use of grid-specific inflation factor to ensure model spread ####
...
Run_AWRAL_EnKF_W_Calib_GridIF <- function(catname, IF_vec, Ne, par_mat, 
  ...
  # mod_run2 =  awra_run_func(N_grid = N_GRID, ALL_FORCING = all_forcing,
